...
public class Main {
    public static void main(String[] args) {
                ...
                if (empate) {
                    ...
                    JOptionPane.showMessageDialog(null, "O jogador eliminado é: " + pessoaEliminada + ".\n\nLamento, mas chegou a hora de deixar a casa. Obrigado por sua participação.", "Eliminação", JOptionPane.INFORMATION_MESSAGE);
                }
            }
        }